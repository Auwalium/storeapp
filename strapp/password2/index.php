...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">All Disabled users</h2><hr />
       
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View All Disabled Users</button>
        <hr />
        ...
        $stmt = $db_con->prepare("SELECT * FROM users where noti = 3  ORDER BY id DESC");
        $stmt->execute();
