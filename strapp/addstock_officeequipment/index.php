  ...
  <div class="well" style="display: table;">
	...
	<div class="container">
		...
		<img src="edit.png" width="20px" /></span> Go Back to Store Module for Report </button></a><br>
		 ...
		 <a  href="../addstock4officeequipment" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Store Ledger and Dispatched Report </button></a><br>
		
		<a  href="../dispatch4officeequipment" title="Click here" target = "window">
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock where category = 'Office Equipment' ORDER BY id DESC");
        $stmt->execute();
