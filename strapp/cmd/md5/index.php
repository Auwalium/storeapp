...
<body>
	...
	<div class="container" style="overflow-x: auto;">
        ...
        <div class="content-loader1">
						...
						FROM stock inner join requestitem where  stock.name = requestitem.name AND (requestitem.noti = 1 )");
						$stmt->execute();
						while($row=$stmt->fetch(PDO::FETCH_ASSOC))
						{
						...
						$id=$row['id'];
							...
							<td> <a id="<?php echo $row['id']; ?>"  class="btn btn-default btn-rounded mb-4"  data-toggle="modal" data-target="#modalLoginForm">Click</a>
</td>
