		...
		<div class="container" style="margin-right: auto; margin-left: auto;">
			<div class="wrapper " style="width: 40%; margin: auto;">
				...
				<form method="post" action="login.php">
					...
					<div class="col-md-12" style="text-align: right; background-color: green; color: white;"><center><h3><i class="glyphicon glyphicon-phone-alt" >&nbsp</i>FMC PHONE DIRECTORY</h3><a href="cug.php" target = 'new window' style="color:white;"> Click here to view FMC phone Directory</a></center></div>
					<div class="col-md-12 fmch"><h2 >FMC KEFFI STORE</h2></div>
