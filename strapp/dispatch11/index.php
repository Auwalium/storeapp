...
<body>
	...
	<div class="container1">
        ...
        <center><h2 class="form-signin-heading">Approved Items Awaiting Dispatch.</h2></center><hr />
         <center><h5 class="form-signin-heading">Please note the item code, category and stock level you want to dispatch in store before you click on dispatch link.</h5></center><hr />
        <hr />
        ...
        $stmt = $db_con->prepare("SELECT * FROM approveditem ORDER BY emp_id ");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			?>
