          ...
          <div class="card-body p-0" >
            ...
            <div class="row" style='background-color:#eee;'>
              ...
              <center class='logo' style='background-color:#eee;;'>
               <h1 class="h4 text-gray-900 mb-4"> STOCK MGT SYSTEM FOR<BR> FMC KEFFI</h1>
              <img src='img/fmc.jpg' id="logo" alt='Logo' style="border-radius:55px;background-color:transparent;"/>
              ...
              <div class="col-lg-6" style='background-color:lavender;'>
                <div class="p-5">
                  ...
                  <div class="text-center">
                    <!-- <a class="small" href="register.php">Register a New User</a> -->
                  </div>
                </div>
              </div>
            </div>
