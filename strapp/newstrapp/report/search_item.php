 ...
 <table class='table' id='summary_table'>
    ...
    $result = mysqli_query($con,$sql);
        ...
        print_r($sql);
            ...
            <?php echo "<a href='edit_form.php?price=$price&itemname=$search_value&id=$id&supplier=$name&phone=$phone&descrip=$descrip' class='badge badge-primary'> CLICK TO SELECT</a>";?> 
