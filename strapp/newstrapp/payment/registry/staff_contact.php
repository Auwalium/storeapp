   ...
   include('../includes/dbconnect.php');
    ...
    if (isset($_POST['submit'])){
        ...
        $_SESSION['email'] = htmlentities($_POST['email']);
		 ...
		 values ('$PhoneNumber', '$PhoneNumber2', '$Nationality', '$State', '$Lga', '$StreetAddr', '$Email', '$fileNo') ";
print_r($sql);
...
<input type="hidden" class="form-control" name="fileNo" value ="<?php echo $_SESSION['fileNo']; ?>"required><br>
