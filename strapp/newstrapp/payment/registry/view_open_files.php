...
<body>
  ...
  include('../includes/dbconnect.php');
    ...
    echo"<td> <a class='btn-sm btn-success' href='all_files.php'> BACK</a> </td></td><td><h4>$lname</h4> </td> <td><h4>$fname</h4> </td> <td><h4>$oname</h4></td> <td><a class='btn-sm btn-success' href='view_electronic_files.php?id=$sid'>VIEW ELECTRONIC FILES </a></td> " ; 
...
<?php     
  include('../includes/dbconnect.php');
       ...
       <td> $size</td>";
       ?>
       <td> <a  class='btn-sm btn-info' href= "OPEN/<?php echo $name ?>" > View Archived File </a>
 <br/> 
...
<h4 class="modal-title" id="myModalLabel">View Archived Files</h4>
</div>
<div class="modal-body">
 <a  class='btn-sm btn-info' href= "OPEN/<?php echo $name ?>"  > View Archived File </a>
