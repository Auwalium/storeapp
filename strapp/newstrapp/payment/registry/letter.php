...
$result =mysqli_query($con, $query);  
    ...
    $sql1 = "INSERT INTO document1(staff_id,writers_add,recipient_add,salutation,title,body, complimentary_close,department_unit) VALUES ('$fid','$wa','$ra','$sal','$tit', '$cont','$cc','$dept_unit')";
    
    if(mysqli_query($con, $sql1)){
    
    
    echo" Your Document was Successfully Sent to the"." ".$dept_unit;
    ?>
<script>
...
<?php
    ...
    include('../includes/dbconnect.php'); 
     ...
     $fid = $_SESSION['username'];   
    $sql = "SELECT * FROM document where staff_id= $fid ORDER BY did DESC LIMIT 1";
...
while($row = $result->fetch_assoc()) {
 ...
 <form action="" method="post">
    ...
    <thead>
   <th style='text-align:center;'> <?php echo"<p class='btn btn-primary' >"."APPLICATION ID".":"."<span style='color:red; font-weight:bold; font-size:15px;'>".$fid."/".$did."</span>"."</p>"; ?>
    </thead>
...
?>
  ...
  <tr> 
   ...
   <textarea cols='30' rows='2' id='writers_addcomp_close' name='comp_close' > <?php  echo $complimentary_close; ?>  </textarea>
    ...
    <center>
      <td>
<input type="submit" name='submit' value="SEND" class='btn btn-success'style='text-align:center;'>
