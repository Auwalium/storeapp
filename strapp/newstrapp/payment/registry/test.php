   ...
   include('../includes/dbconnect.php');
    ...
    if (isset($_POST['submit'])){
        ...
        $_SESSION['email'] = htmlentities($_POST['email']);
         ...
         $sql = "INSERT into permanentcontact (phone1, phone2, nationality, state, LGA, street, email, staffID) 
...
<input type="text" class="form-control" name="fileNo" value ="<?php echo $_SESSION['fileNo']; ?>"required><br>
...
<br>
    <b>Street Address:</b> <textarea class="form-control" rows="3" name="street"></textarea><br>
