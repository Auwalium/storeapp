...
<input type="text" class="form-control" placeholder='Are you sure that you want to reset password for staff with id ="<?php echo $username  ?>"? if no, click cancel else click yes'>		
...
<?php
					if(isset($_POST['submit9']))
					{
						...
						$sql = "update users set password = '$password' where id =$did ";
						 print_r($sql);
