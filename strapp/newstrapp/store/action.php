...
if(isset($_POST["action"]))
{
	...
	{
		$query1 = "
		INSERT INTO item (generic_name, brand_name, item_category, date_created,created_by) 
		VALUES ('".$_POST["generic_name"]."', '".$_POST["brand_name"]."', 
		'".$_POST["item_category"]."' , '".$_POST["date_created"]."', '".$_POST["created_by"]."')
		";
		print_r($query1);
