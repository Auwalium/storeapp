...
$row9=mysqli_fetch_array($result);
		...
		$sql="SELECT * from stock where name like '%$search_value%'";
...
<table class='table' id='summary_table'>
	...
	include('../includes/dbconnect.php');
		...
		$sql="SELECT * from stock1 where name like '%$search_value%'";
        $result = mysqli_query($con,$sql);
...
<table class='table' id='summary_table'>
	...
	include('../includes/dbconnect.php');
		...
		$sql="SELECT * from requestitem1 where name like '%$search_value%'";
        $result = mysqli_query($con,$sql);
