...
<body>
 <div class="well" style="display: table;">
    ...
    <div class="container">
        ...
        <center><h2 class="form-signin-heading">Item'S DETAILS</h2></center><hr />
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View All Items</button>
       <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Register A New Item</button>
        <hr />
		...
		<th>Item NAME</th>	
		<th>DESCRIPTION</th>
		<th>PRICE CONTROL COMMITTEE (PRICE)</th>
		<th>EDIT</th>
		<th>DELETE</th>
        </tr>
        </thead>
        ...
        $stmt = $db_con->prepare("SELECT * FROM item  ORDER BY id DESC");
		//print_r($stmt);
        $stmt->execute();
