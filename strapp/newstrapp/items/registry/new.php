...
<div class="col-md-6 col-lg-8 col-xlg-3" id="form_content">
   <div class="card" id='form'>
                         ...
                         <a href='new_staff_documentation.php'> Back</a>
                         <!--<a href='residential.php' style="float:right;"> Next</a> -->
	...
	<header>
	<h5 align="center">STAFF CONTACT FORM </h5>
	</header>
<script>
...
<?php
   ...
   include('../includes/dbconnect.php');
    ...
    if (isset($_POST['submit'])){
        ...
        $_SESSION['Phone1'] = htmlentities($_POST['Phone1']);
        $_SESSION['Phone2'] = htmlentities($_POST['Phone2']);
        ...
        $_SESSION['StreetArea'] = htmlentities($_POST['StreetArea']);
        $_SESSION['Email'] = htmlentities($_POST['Email']);
        
         $sql = "INSERT into stfcontactperm (Phone1, Phone2, Nationality, State, LGA, StreetArea, Email, StaffID)
         values ('$PhoneNumber', '$PhoneNumber2', '$Nationality', '$State', '$Lga', '$StreetAddr', '$Email', '$fid') ";

         if (mysqli_query($con, $sql)){


          echo "<p class='btn-lg btn-success'>Contact Created Successfully";
      ?>

            <script>

            setTimeout(function(){
            window.location.href = 'residential.php';
            }, 2000);
...
<b>Phone Number I :</b> <input type="number" class="form-control" name="Phone1" required><br>
    
    </div>
    <b>Phone Number II :</b> <input type="number" class="form-control" name="Phone2" ><br>
        <b>Nationality :</b> 
        <select name="Nationality" class="form-control">
            <option value="Nigerian" class="form-control" name="Nationality" required>Nigerian</option>
            <option value="Non-Nigerian" class="form-control" name="Nationality" required>Non-Nigerian</option>

            </select><br>

<b>Select Marital Status:</b>
...
<br>
    <b>Street Address:</b> <textarea class="form-control" rows="3" name="StreetArea"></textarea><br>
    <label for="email"><b>E.Mail Address:</b></label><input type="email" class="form-control" name="Email">
