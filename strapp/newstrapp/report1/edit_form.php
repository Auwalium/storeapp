...
?>
	 <tr>
            <td>Item Name</td>
            <td><input type='hidden' name='name' class='form-control' value='<?php echo $row['generic_name']; ?>' required><?php echo $row['generic_name']."".$row['brand_name'] ?></td>
        </tr>
		<tr>
            <td>quantity</td>
		...
		<tr> 
				...
				<td>
				  <select name="dept">
				                ...
				                <option value = "MD Office">MD's Office</option>
		...
		<tr> 
			...
			<tr> 
				...
				<td><input type="hidden" name="rname" value='<?php echo $rname; ?>' required><?php echo $rname; ?></td>
			</tr>
			<tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> 
