  ...
  <div class="well" style="display: table;">
	...
	<div class="container">
        ...
        <div class="content-loader">
        	...
        	<a  href="../dispatch_fuel/index.php" title="Click here" target = "new window">
		<img src="edit.png" width="20px" /></span> Click Here to Dispatch Fuel</button> </a>
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock where category = 'fuel' or category = 'diseal' ORDER BY id DESC");
        $stmt->execute();
