...
<div class="well" style="display: table;">
    ...
    <div class="container">
		...
		<img src="edit.png" width="20px" /></span> Go Back to Store Module for Report and to Dispatch Item</button> </a>
		
		<a  href="received.php" title="Click here" target = "new window">
		<img src="edit.png" width="20px" /></span> Good Received Voucher</button> </a>
		<hr />
...
<body>
	...
	<div class="container">
       ...
       <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Add Comment on Item</button>
        <hr />
        <center><h4 class="form-signin-heading">Check Item ID and Stock Level of item you want to approve before you proceed</h4></center><hr />
        ...
        <th><h1 style="text-decoration:underline"><center><button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span>Delete Approved Item</th>
        </tr>
        </thead>
        <tbody>
        ...
        $stmt = $db_con->prepare("SELECT * FROM requestitem where noti = 0 ORDER BY id DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			?>
