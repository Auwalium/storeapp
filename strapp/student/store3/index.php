...
<div class="well" style="display: table;">
    ...
    <div class="container">
       ...
       <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Register A New STUDENT</button>
        ...
        $stmt = $db_con->prepare("SELECT * FROM biodata where noti = 1 ORDER BY id DESC");
        $stmt->execute();
...
<a href="http://localhost/schools/md/index.php" style="color:crimson; font-weight:normal; text-shadow:1px 2px black; text-decoration:none;">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</tr></center></h2>
