...
<div class="well" style="display: table;">
    ...
    <div class="container">
       ...
       <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Register A New STUDENT</button>
		...
		<th>Term</th>
		<th>Class</th>
		<th>Attach Assignment to student</th>
		<th>Attach student Result</th>
        ...
        $stmt = $db_con->prepare("SELECT * FROM session where sclass = 'ss1' and year = 2019 and term = 'third term' ORDER BY id DESC");
        $stmt->execute();
