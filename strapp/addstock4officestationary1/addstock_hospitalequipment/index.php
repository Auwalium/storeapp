...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
		...
		<a  href="../dispatch4hospitalequipment" title="Click here" target = "window">
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock  where category = 'Hospital Equipment' ORDER BY id DESC");
        $stmt->execute();
