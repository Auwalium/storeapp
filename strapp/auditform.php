...
<div class="main">
  ...
  AUDIT ASSET CAPTURE FORM .
  </center></h3>
  <form action="auditform.php" method="post" name="form1">
  <?php
session_start();
...
if(isset($_POST['Submit'])) {
	...
	$snum           = mysqli_real_escape_string($mysqli, $_POST['snum']);
	$lb           = mysqli_real_escape_string($mysqli, $_POST['lb']);
	$lr           = mysqli_real_escape_string($mysqli, $_POST['lr']);
	$model           = mysqli_real_escape_string($mysqli, $_POST['model']);
	$date          = mysqli_real_escape_string($mysqli, $_POST['date']);
	
	$result = mysqli_query($mysqli, "INSERT INTO audit(name,aname, qty,snum,lb, lr, model,date) 
