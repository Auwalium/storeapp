...
<div class="main">
  ...
  You can carry out the following Operation.<br><br></center></h1>
	<button class="btn AddItem" onClick="window.location.href='../procurement/company1'">COMPANY 1</button>  
    <button class="btn GenR" onClick="window.location.href='../procurement/company2'">COMPANY 2</button>
	<button class="btn GenR" onClick="window.location.href='../procurement/company3'">COMPANY 3</button>
	<button class="btn AddItem" onClick="window.location.href='../procurement/company4'">COMPANY 4</button>
	<button class="btn AddItem" onClick="window.location.href='../procurement/company6'">COMPANY 5</button>
	<button class="btn GenR" onClick="window.location.href='../report8.html'">REPORT</button> 
