 ...
 FILL THIS FORM TO RAISED LPO.
  ...
  <form action="requestrequest.php" method="post" name="form1">
		<table width="40%" align = "center"  border="10">
			...
			<tr> 
				<td>LPO NUMBER</td>
				<td><input type="text" name="lpo"></td>
			</tr>
			...
			<tr> 
				<td>DESCRIPTION</td>
				<td><input type="int" name="DESCRIP"></td>
			</tr>
			<tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> 
			...
			<tr> 
				<td>RAISED BY</td>
				<td><input type="text" name="rby" value=<?php echo "$rname" ?> ></td>
			</tr>
			<tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> <tr> </tr> 
...
if(isset($_POST['Submit'])) {
	...
	$lpo          = mysqli_real_escape_string($mysqli, $_POST['lpo']);
	...
	$result = mysqli_query($mysqli, "INSERT INTO raisedlpo(lpo, name, rname, descrip,qty, rdate) 
		VALUES('$lpo', '$name', '$rname', '$descrip','$qty', '$rdate')");
