...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM dispatch  ");
        $stmt->execute();
...
if(isset($_POST['search_submit1'])){
  $name = $_POST['name'];
 $query="select * from dispatch1 where name = '$name' ";
 $result=mysqli_query($mysqli,$query);
 echo '<!DOCTYPE html>
<html lang="en">
  <head>
...
if(isset($_POST['search_submit1'])){
  $name = $_POST['name'];
 $query="select * from requestitem1 where name = '$name' ";
 $result=mysqli_query($mysqli,$query);
 echo '<!DOCTYPE html>
<html lang="en">
  <head>
...
if(isset($_POST['search_submit1'])){
  $name = $_POST['name'];
 $query="select * from approveditem1 where name = '$name' ";
 $result=mysqli_query($mysqli,$query);
 echo '<!DOCTYPE html>
<html lang="en">
  <head>
...
<!-- Optional JavaScript -->
 ...
 <html>
 <h4 ><center><h4 style="padding-top:50px;"><center>
 ITEMS stock level updated BY NAME
  </center></h4>
...
if(isset($_POST['search_submit1'])){
  $name = $_POST['name'];
 $query="select * from updatestock where name = '$name' ";
 $result=mysqli_query($mysqli,$query);
 echo '<!DOCTYPE html>
<html lang="en">
  <head>
...
<!-- Optional JavaScript -->
   ...
   <a href="../logout.php" class="btn btn-danger">Sign Out </a></center><br>
    <a href="../trace/index.php" class="btn btn-primary">Refresh </a></center>
</html>';
...
<?php
 $name = $_POST['name'];
$sql="SELECT SUM(qa) FROM dispatch where name = '$name'";
	
$result=mysqli_query($mysqli,$sql);
$row6=mysqli_fetch_array($result);

echo "<p style='color:green; text-align:center'>TOTAL OF  ".$row6[0]." NUMBER OF ".$name." "."HAS BEEN DISTRIBUTED TO THE VARIOUS DEPARTMENTS AND UNITS IN FMC."; 
