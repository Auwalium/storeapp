    ...
    <h4>Welcome </h4>
      <?php  if (isset($_SESSION['user'])) : ?>
        ...
        <div class="container">
			...
			<h3 align="center">Dept/Units Request Awaiting HEAD OF CITTU Recommendation<br> for Store to take Action.</a></h3><br />
			<br />
		...
		<div id="user_dialog" title="Add Data">
			<form method="post" id="user_form">
				...
				<div class="form-group">
					<label>Recommended Quantity by HEAD OF CITTU</label>
