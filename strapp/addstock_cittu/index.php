...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
		...
		<a  href="../dispatch4cittu" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Dispatch Item</button></a>
		
		<a  href="../addstock4cittu" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Store Ledger</button></a>
		
		<a  href="../citturec" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Approve Items</button></a>
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock where category = 'cittu' ORDER BY id DESC");
        $stmt->execute();
