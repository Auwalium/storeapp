...
require_once '../dbconfig.php';
	...
	if($_POST)
	{
		...
		if($stmt->execute())
		{
			...
			$stmt = $db_con->prepare("INSERT INTO dispatch (name,dept,qis,qa,appv,adate,total,rdate,category,unit,sunit, dispatchby) VALUES('$name', '$dept', '$qis', '$qa','$appv','$adate','$total','$rdate','$category','$unit','$sunit','$dispatchby')");
			if($stmt->execute())
		{
			echo "Successfully updated";
		}
