...
if(isset($_POST['Submit'])) {
	...
	$result = mysqli_query($mysqli, "INSERT INTO requestitem(name, quantity,phone,dept, unit, sunit,rname,rdate) 
		VALUES('$name','$quantity','$phone','$dept','$unit','$sunit','$rname','$rdate')");
		$result = mysqli_query($mysqli, "INSERT INTO requestitem1(name, quantity,phone,dept, unit, sunit,rname,rdate) 
		VALUES('$name','$quantity','$phone','$dept','$unit','$sunit','$rname','$rdate')");
		
		//display success message
		echo '<h3 style="text-decoration:underline; color = green;" ><center>Item Requisition is successful and will be treated. You can Request another item or logout but dont repeat the same request</center></h3>';
}	
?>
  <h3 style="text-decoration:underline"><center>
  REQUEST FOR PROCURED GOODS IN STORE.
  </center></h3>
  <form action="requestrequest.php" method="post" name="form1">
  <?php
session_start();
$rname = $_SESSION["username"];
