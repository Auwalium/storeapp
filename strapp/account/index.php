    ...
    <h4>Welcome </h4>
      <?php  if (isset($_SESSION['user'])) : ?>
        ...
        <div class="container">
			...
			<h3 align="center">Request Awaiting Head of Account Recommendation<br>To Enable Further Action To Be Taken.</a></h3><br />
			<br />
		...
		<div id="user_dialog" title="Add Data">
			<form method="post" id="user_form">
				...
				<div class="form-group">
					...
					<input type="text" name="rqmd" id="rqmd" class="form-control" />
...
$(document).ready(function(){  
	...
	$('#user_form').on('submit', function(event){
		...
		if($('#rqmd').val() == '')
		{
			error_rqmd = 'rqmd is required';
			$('#error_rqmd').text(error_quantity);
			$('#rqmd').css('border-color', '#cc0000');
		}
		else
		{
			error_rqmd = '';
			$('#error_rqmd').text(error_quantity);
			$('#rqmd').css('border-color', '');
		}
		if($('#first_name').val() == '')
		{
		...
		if(error_first_name != '' || error_last_name != '' || error_rqmd != '')
		{
			return false;
		}
		else
