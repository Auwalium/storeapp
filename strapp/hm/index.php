...
<div class="well" style="display: table;">
	...
	<div class="container">
        ...
        $stmt = $db_con->prepare("SELECT * FROM stock where category = 'Maintenance Items'");
        $stmt->execute();
...
<body>
	...
	<div class="container">
        ...
        <tr>
            ...
            <th width="30">RECOMM QTY BY Head of Maintenance</th>
        ...
        $stmt = $db_con->prepare("SELECT * FROM requestitem where category = 'Maintenance Items' AND noti = 1 ORDER BY id DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			?>
