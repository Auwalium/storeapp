...
$rname = $_SESSION["username"];     
    ...
    <table class='table table-bordered'>
		...
		<tr>
            ...
            <td><input type='text' name='qabs' class='form-control' value='<?php echo $row['rqmd1']; ?>' ></td>
        </tr>
        <tr>
		...
		<tr>
		 ...
		 <tr>
            <td>code</td>
            <td><input type='text' name='code' class='form-control'value='<?php echo $row['code']; ?>'  ></td>
        </tr>
 
        <tr>
            <td>stock level</td>
            <td><input type='text' name='slevel' class='form-control'value='<?php echo $row['slevel']; ?>'  ></td>
        </tr>
