...
<div class="main">
   ...
   <form action="approval2.php" method="post" name="form1">
...
<a href="search7.html" style="color:crimson; font-weight:normal; text-shadow:1px 2px black; text-decoration:none;">Dispatch Another Item </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$result = mysqli_query($mysqli, "DELETE FROM approveditem WHERE emp_id = $code");
 if  (mysqli_query($mysqli, "DELETE FROM approveditem WHERE emp_id = $code") === TRUE) 
