...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
        ...
        <th><button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span>Confirmed Item as scrap</th>
