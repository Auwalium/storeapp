...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
		...
		<img src="edit.png" width="20px" /></span> Go Back to Store Module for Report </button>
        
		<a  href="../dispatch4scrap" title="Click here" target = "window">
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock  where category = 'scrap' ORDER BY id DESC");
        $stmt->execute();
