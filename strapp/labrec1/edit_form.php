...
#dis{
    ...
    <table class='table table-bordered'>
        ...
        <tr>
		 ...
		 <tr>
            <td>Recommended Qty by HEAD OF LAB</td>
            <td><input type='int' name='rqmd1' class='form-control' value='<?php echo $row['rqmd1']; ?>' required></td>
        </tr>
		<tr>
            <td>Approved Qty by Store</td>
            <td><input type='int' name='qabs' class='form-control' value='<?php echo $row['rqmd1']; ?>' required></td>
        </tr>
		<tr>
            <td>Code</td>
            <td><input type='int' name='code' class='form-control'  required></td>
        </tr>
		<tr>
            <td>Stock Level</td>
