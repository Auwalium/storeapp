...
<div class="well" style="display: table;">
	...
	<div class="container">
        ...
        <CENTER><h2 class="form-signin-heading">ITEMS IN STORE AND THEIR STOCK LEVEL</h2></CENTER>
           <hr />
        ...
        $stmt = $db_con->prepare("SELECT * FROM stock where category = 'cittu'");
        $stmt->execute();
...
<body>
	...
	<div class="container">
        ...
        <center><h2 class="form-signin-heading">Request from CITTU Sub_Units Awaiting Recommendation for Approval.</center></h2><hr />
		...
		<th width="30">Sub Unit</th>
            ...
            <th width="30">RECOMM QTY BY Head of CITTU</th>
        ...
        $stmt = $db_con->prepare("SELECT * FROM requestitem where category = 'cittu' and noti = 1 and rdate > '2020-2-31' ORDER BY id DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			?>
