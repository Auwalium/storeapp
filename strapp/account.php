            ...
            <div class="clearfix">
              <div class="column menu">
                <ul>
                  ...
                  <li><a href="account.php?logout='1'"><span class="glyphicon glyphicon-off" style="background-color:rgb(100 78 200);"></span> logout</a></li>
                ...
                <div class="column content" style="overflow-y: auto; overflow-x: auto;">
                 <div class="column content" style="background-color: white; height: 10%; width:100%;">
                    ...
                    <!--<div class="operation">-->
                            ...
                            <button class="btno" onClick="window.location.href='./caccount1'">Company Supply Payment</button>
