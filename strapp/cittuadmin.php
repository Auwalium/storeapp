...
<div class="container">
	...
	<form method="post" action="cittuadmin.php">
		
		<div class="row padder">
			<div class="col-md-2"><img src="care_logo_mysql.gif " align="right" style="padding-top: 10px;"></div>
			...
			<br><div class="col-md-2 col-md-offset-2" ><a href="cittuadmin/index.php" style=" font-size: 25px;   width: 20%; text-align: right;"></span > </a>
		...
		<a  href="cittuadmin2/index.php" title="Click here" target = "new window">
		<img src="edit.png" width="20px" /></span> Approved Items</button> </a><br>
		
		<a  href="password/index.php" title="Click here" target = "new window">
		<img src="edit.png" width="20px" /></span> User Detail Page</button> </a><br>
		
		<a  href="password2/index.php" title="Click here" target = "new window">
		<img src="edit.png" width="20px" /></span> Enable disabled User</button> </a><br>
</body>
</html>