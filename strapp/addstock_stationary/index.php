...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
        ...
        <a  href="../dispatch4stationary" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Dispatch Item</button></a><br>
		
		 <a  href="../addstock4officestationary" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Store Ledger</button></a><br>
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock where category = 'Office Stationary' ORDER BY id DESC");
        $stmt->execute();
