...
$rname = $_SESSION["username"];     
    ...
    <table class='table table-bordered'>
		...
		<tr> 
				...
				<td>
				  <select name="category">
								...
								<option value = "Hospital Equipment">select category</option>
		...
		<tr>
            <td>Approved By</td>
            <td><input type='text' name='appv' class='form-control' value='<?php echo $row['rname']; ?>' ></td>
        </tr>
		<tr>
            <td>Requested Qty</td>
        ...
        <tr>
            ...
            <td><input type='text' name='comment' class='form-control' value='<?php echo $row['comment']; ?>'></td>
        </tr>
		<tr>
            <td>Comment by MD</td>
