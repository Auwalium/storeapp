...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
		...
		<a  href="../dispatch4theatre" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Dispatch Item</button></a><br>
		
		<a  href="../thearec" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Approve Item</button></a><br>
		
		 <a  href="../addstock4theatre" title="Click here" target = "window">
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock where category = 'theatre' ORDER BY id DESC");
        $stmt->execute();
