...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock WHERE category ='radiology' or category = 'laboratory' 
		or category= 'theatre' or category='dental' or category='pharmacy'    ORDER BY id DESC");
        $stmt->execute();
