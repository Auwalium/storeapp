...
<div class="main">
  ...
  You can carry out the following Operation.<br><br></center></h1>
	...
	<button class="btn AddItem" onClick="window.location.href='audit/audit1'">  audit</button>
	<button class="btn Modify" onClick="window.location.href='register2.php'" > audit2</button>  
