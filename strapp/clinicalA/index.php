    ...
    <h4>Welcome </h4>
      <?php  if (isset($_SESSION['user'])) : ?>
        ...
        <div class="container">
			...
			<h3 align="center">Request Awaiting Head of Clinical Services Recommendation<br>To Enable Further Action To Be Taken.</a></h3><br />
			<br />
		...
		<div id="user_dialog" title="Add Data">
			<form method="post" id="user_form">
				...
				<div class="form-group">
					...
					<input type="text" name="rqs" id="rqs" class="form-control" />
...
$(document).ready(function(){  
	...
	$('#user_form').on('submit', function(event){
		...
		if($('#rqs').val() == '')
		{
			error_rqmd1 = 'rqs is required';
			$('#error_rqmd1').text(error_quantity);
			$('#rqs').css('border-color', '#cc0000');
		}
		else
		{
			error_rqmd1 = '';
			$('#error_rqmd1').text(error_quantity);
			$('#rqs').css('border-color', '');
		}
		if($('#first_name').val() == '')
		{
