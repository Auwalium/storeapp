...
<div class="main">
  ...
  You can carry out the following Operation.<br><br></center></h1>
	...
	<button class="btn Modify" onClick="window.location.href='search2.html'" >SEARCH GOODS IN STORE</button> 
	
	<button class="btn AddItem" onClick="window.location.href='apply.html'">  APPLY FOR GOODS THAT SHOULD BE PROCURED</button>
	<button class="btn Modify" onClick="window.location.href='requestrequest.php'" > REQUEST FOR GOODS IN STORE</button>  
	<button class="btn AddItem" onClick="window.location.href='dispatchreport2.php'" >VIEW YOUR PREVIOUS REQUEST AWAITING APPROVAL</button> 
        <button class="btn Modify" onClick="window.location.href='dispatchreport3.php'" >VIEW YOUR REQUEST THAT HAS BEEN APPROVED</button> 
