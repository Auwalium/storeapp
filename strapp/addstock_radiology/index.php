...
<body>
  <div class="well" style="display: table;">
	...
	<div class="container">
		...
		<a  href="../dispatch4radiology" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Dispatch Item</button></a><br>
		
		<a  href="../radrec" title="Click here" target = "window">
		<img src="edit.png" width="20px" /></span> Approve Item</button></a><br>
		
		 <a  href="../addstock4radiology" title="Click here" target = "window">
		...
		$stmt->execute();
        $stmt = $db_con->prepare("SELECT * FROM stock where category = 'Radiology Goods' ORDER BY id DESC");
        $stmt->execute();
