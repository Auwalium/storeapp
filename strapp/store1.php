...
<div class="main">
  ...
  You can carry out the following Operation.<br><br></center></h1>
	...
	<button class="btn AddItem" onClick="window.location.href='ItemInfo.php'">ADD GOODS TO STORE</button>
	
	<button class="btn Remove" onClick="window.location.href='search.html'"	>DISPATCH 1 ITEMS</button>
	<button class="btn Remove" onClick="window.location.href='dispatch'"	>DISPATCH 2 ITEMS</button>
	<button class="btn Remove" onClick="window.location.href='dispatch1'"	>DISPATCH 3 ITEMS</button>
	<button class="btn AddItem" onClick="window.location.href='approveditem.php'">VIEW ALL APPROVED ITEMS</button>
	<button class="btn GenR" onClick="window.location.href='report5.html'">REPORT</button> 
