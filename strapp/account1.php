...
<div class="main">
  ...
  You can carry out the following Operation.<br><br></center></h1>
	...
	<button class="btn AddItem" onClick="window.location.href='register1.php'">  account1</button>
	<button class="btn Modify" onClick="window.location.href='register2.php'" > account2</button>  
	<button class="btn Modify" onClick="window.location.href='register3.php'" > account3</button> 
	<button class="btn Modify" onClick="window.location.href='register4.php'" > account4</button>
	<button class="btn Modify" onClick="window.location.href='register5.php'" > account5</button>  	
