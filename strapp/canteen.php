...
<div class="main">
  ...
  You can carry out the following Operation.<br><br></center></h1>
	...
	<button class="btn AddItem" onClick="window.location.href='canteen'">  Add Food to Canteen Store</button>
	<button class="btn Modify" onClick="window.location.href='canteen1'" > Canteen 2</button> 
	<button class="btn Modify" onClick="window.location.href='canteen4'" > Customer's Food Approval Form</button>
	<button class="btn Modify" onClick="window.location.href='canteen3'" > Customer's Food Request Form</button>
